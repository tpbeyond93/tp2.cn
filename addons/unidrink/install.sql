CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_address` (
  ...
  `door_number` varchar(100) NOT NULL DEFAULT '' COMMENT '门牌号',
  `sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别:0=男人,1=女人',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_ads` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL COMMENT '图片',
  `switch` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否显现',
  ...
  PRIMARY KEY (`id`),
  KEY `weigh` (`weigh`,`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='广告图管理';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_area` (
...
CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_bill` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `out_trade_no` varchar(32) NOT NULL DEFAULT '' COMMENT '订单编号',
  `type` tinyint(1) NOT NULL COMMENT '类型:1=消费,2=充值,3=退款',
  `total_price` decimal(10,2) NOT NULL COMMENT '订单金额',
  `real_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '价值金额',
  `type_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '对应类型id:type=2时指的是recharge表,其他则是order表',
  `pay_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '付款方式:0=无,5=余额支付,3=微信支付,4=支付宝',
  `effecttime` int(10) NOT NULL DEFAULT '0' COMMENT '生效时间:0=未生效',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=85854243482898433 DEFAULT CHARSET=utf8mb4 COMMENT='用户账单';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_category` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '父ID',
  `type` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '栏目类型',
  `name` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `nickname` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `flag` set('discount') CHARACTER SET utf8 NOT NULL DEFAULT '',
  `image` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '图片',
  `keywords` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '关键字',
  `description` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '描述',
  `diyname` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '自定义名称',
  `createtime` int(10) DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  `status` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '状态',
  `shop_id` varchar(500) CHARACTER SET utf8 NOT NULL DEFAULT '0' COMMENT '所支持的店铺id用'',''区分，0代表全部',
  PRIMARY KEY (`id`),
  KEY `weigh` (`weigh`,`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='分类表';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_condiment` (
  ...
  `deletetime` int(10) DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='调味小料管理';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_coupon` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `receive` int(10) NOT NULL DEFAULT '0' COMMENT '已领取',
  `distribute` int(10) NOT NULL DEFAULT '0' COMMENT '发行数量',
  ...
  `limit` int(10) DEFAULT '1' COMMENT '限领数量',
  PRIMARY KEY (`id`),
  KEY `shop_id` (`shop_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='优惠券表';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_coupon_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `shop_id` varchar(500) NOT NULL DEFAULT '0' COMMENT '店铺id,0表示通用',
  `title` varchar(50) NOT NULL COMMENT '优惠券名称',
  `least` decimal(10,2) NOT NULL COMMENT '消费多少可用',
  ...
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '可用类型:0=通用,1=自取,2=外卖',
  `score` int(10) NOT NULL DEFAULT '0' COMMENT '消耗积分',
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='用户领的优惠券';

CREATE TABLE IF NOT EXISTS `__PREFIX__unidrink_evaluate` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) DEFAULT '0' COMMENT '创建者',
...
create table IF NOT EXISTS __PREFIX__unidrink_order
(
    id             bigint unsigned             not null
        primary key,
    shop_id        int(10)        default 0    not null comment '商家id',
    user_id        int unsigned                null comment '用户id',
    out_trade_no   varchar(32)                 null comment '订单编号',
    order_price    decimal(10, 2) default 0.00 null comment '订单金额',
    discount_price decimal(10, 2)              null comment '优惠价格',
    delivery_price decimal(10, 2)              null comment '运费价格',
    total_price    decimal(10, 2)              null comment '实付价格',
    pay_type       tinyint(1)                  not null comment '付款方式:5=余额支付,3=微信支付,4=支付宝付',
    type           tinyint(1)                  not null comment '购买类型:1=自取,2=外卖',
    ip             varchar(30)                 null comment '下单ip',
    remark         varchar(255)                null comment '订单备注',
    status         tinyint(1)     default 1    not null comment '订单状态:-1=退款,0=取消订单,1=正常啊',
    have_paid      int(10)        default 0    not null comment '已支付:0=否',
    have_made      int(10)        default 0    not null comment '已制作:0=否',
    have_received  int(10)        default 0    not null comment '已收货:0=否',
    have_commented int(10)        default 0    not null comment '已评论:0=否',
    number_id      int(10)        default 0    not null comment '取餐号',
    gettime        int(10)        default 0    not null comment '取餐时间',
    createtime     int(10)                     not null comment '创建时间',
    updatetime     int(10)                     not null comment '更新时间',
    deletetime     int(10)                     null comment '删除时间',
    constraint order_no
        unique (out_trade_no)
)
...
create index shop_id
    on __PREFIX__unidrink_order (shop_id);

create index user_id
    on __PREFIX__unidrink_order (user_id);



create table IF NOT EXISTS __PREFIX__unidrink_order_extend
(
    id           int(10) auto_increment
        primary key,
    user_id      int unsigned      not null comment '用户id',
    order_id     bigint            not null comment '订单id',
    coupon_id    int(10) default 0 not null comment '优惠券id',
    coupon_json  text              null comment '优惠券快照',
    address_id   int(10)           not null comment '地址id',
    address_json text              null comment '地址快照',
    createtime   int(10)           not null comment '创建时间',
    updatetime   int(10)           not null comment '更新时间'
)
    comment '订单扩展表' charset = utf8;

create index order_id
    on __PREFIX__unidrink_order_extend (order_id);




create table IF NOT EXISTS __PREFIX__unidrink_order_number
(
    id       int auto_increment comment '取餐号'
        primary key,
    order_id bigint not null comment '订单id'
)
    comment '订单取餐号表';
...
create table IF NOT EXISTS __PREFIX__unidrink_order_product
(
    ...
    spec_key   varchar(50) default '' not null comment '规格键值',
...
create index `order`
    on __PREFIX__unidrink_order_product (order_id);




create table IF NOT EXISTS __PREFIX__unidrink_product
(
    id            int unsigned auto_increment
        primary key,
    category_id   int(10)      default 0   not null comment '分类ID',
    ...
    sales         int(10)      default 0   not null comment '销售量',
    stock         int(10)      default 0   not null comment '库存',
    look          int(10)      default 0   not null comment '浏览量',
    use_spec      tinyint(1)   default 1   null comment '是否使用规格',
    specList      text                     null comment '规格属性',
    specTableList text                     null comment '规格值',
    weigh         int(10)      default 0   not null comment '权重',
    real_sales    int(10)      default 0   not null comment '真实销量',
    real_look     int(10)      default 0   not null comment '真实浏览量',
    switch        tinyint(1)   default 0   not null comment '是否上架:0=否,1=是',
    updatetime    int(10)                  null comment '更新时间',
    createtime    int(10)                  null comment '创建时间',
    deletetime    int(10)                  null comment '删除时间',
    shop_id       varchar(500) default '0' not null comment '所支持的店铺id用'',''区分，0代表全部',
    condiment_id  varchar(500) default '0' not null comment '小料id用'',''号区分，0表示不用小料',
    no_buy_yet    int(10)      default 0   not null comment '下单未付款量'
)
    comment '产品表';

create index class_id
    on __PREFIX__unidrink_product (category_id);


create table IF NOT EXISTS __PREFIX__unidrink_recharge
(
    id         int(10) auto_increment
        primary key,
    name       varchar(30)          not null comment '标题',
    sales      int(10)    default 0 not null comment '销量',
    value      decimal(10, 2)       not null comment '价值',
    weigh      int(10)    default 0 not null comment '权重',
    status     tinyint(1) default 1 not null comment '状态:1=显示,0=隐藏',
...
create table IF NOT EXISTS __PREFIX__unidrink_service
(
    id         int(10) auto_increment
        primary key,
    name       varchar(100)                                                     not null comment '标题',
    image      varchar(255)                                                     not null comment '图标',
    type       enum ('pages', 'miniprogram', 'menu', 'content') charset utf8mb4 not null comment '类型:pages=页面,miniprogram=跳转小程序,menu=菜单,content=内容',
    content    text charset utf8mb4                                             not null comment '详情',
    pid        int(10)                      default 0                           not null comment '父级id',
    app_id     varchar(50) charset utf8mb4  default ''                          not null comment '小程序app_id',
    pages      varchar(100) charset utf8mb4 default ''                          not null comment '页面路径',
    weigh      int(10)                      default 0                           not null comment '权重',
    status     tinyint(1)                   default 0                           not null comment '状态:0=下架,1=上架',
    createtime int(10)                                                          not null comment '创建时间',
    updatetime int(10)                                                          not null comment '更新时间',
    deletetime int(10)                                                          null comment '删除时间'
)
    comment '我的服务' collate = utf8mb4_unicode_ci;

create index weigh
    on __PREFIX__unidrink_service (weigh, id);



create table IF NOT EXISTS  __PREFIX__unidrink_shop
(
    id             int(10) auto_increment
        primary key,
    name           varchar(100)                not null comment '店铺名称',
    mobile         varchar(20)                 not null comment '店铺电话',
    image          varchar(255)   default ''   not null comment '图片',
    ...
    distance       int(10)        default 0    not null comment '外卖配送距离,单位为千米。0表示不送外卖',
    min_price      decimal(10, 2) default 0.00 not null comment '起送价钱',
    delivery_price decimal(10, 2) default 0.00 not null comment '配送价格',
    notice         varchar(255)   default ''   not null comment '公告',
    status         tinyint(1)     default 0    not null comment '是否营业:0=否,1=是',
    createtime     int(10)                     not null comment '创建时间',
    updatetime     int(10)                     not null comment '更新时间',
    deletetime     int(10)                     null comment '删除时间',
    admin_id       varchar(100)   default ''   not null comment '管理员id',
    uniprint_id    varchar(100)   default ''   not null comment '打印机id'
)
    comment '门店管理';


create table IF NOT EXISTS __PREFIX__unidrink_user_extend
(
    id           int(10) auto_increment
        primary key,
    user_id      int(10)                     not null comment '基础用户表id',
    openid       varchar(32)                 not null comment '微信小程序openid',
    currentValue decimal(10, 2) default 0.00 not null comment '历史消费金额',
    createtime   int(10)                     not null comment '创建时间',
    updatetime   int(10)                     not null comment '更新时间'
)
    charset = utf8;
...
create index openid
    on __PREFIX__unidrink_user_extend (openid);

create index user_id
    on __PREFIX__unidrink_user_extend (user_id);



-- 配置默认值 --
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (1, 'name', 'basic', 'Site name', '请填写站点名称', 'string', 'uniDrink', '', 'required', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (9, 'categorytype', 'dictionary', 'Category type', '', 'array', '{"product":"Product"}', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (10, 'configgroup', 'dictionary', 'Config group', '', 'array', '{"basic":"Basic","dictionary":"Dictionary","wechat":"Wechat","subscribe_msg":"Subscribe Msg"}', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (16, 'salt', 'basic', '密码盐', '加密数据库键值', 'string', 'write your salf', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (17, 'app_id', 'wechat', 'AppID(小程序ID)', '', 'string', 'wx625a2998......', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (18, 'secret', 'wechat', 'AppSecret(小程序密钥)', '', 'string', 'ba2e7ffad5988b.........', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (19, 'mch_id', 'wechat', '商户号', '', 'string', '15701.....', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (20, 'key', 'wechat', 'api秘钥', '', 'string', '40e12efa117aec396e172.......', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (21, 'notify_url', 'wechat', '订单回调地址', '', 'string', 'http://drink.weivee.com/addons/unidrink/pay/notify', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (22, 'cert_path', 'wechat', 'API证书（退款用）', '', 'string', '/home/wwwroot/drink.weivee.com/addons/unidrink/cert/apiclient_cert.pem', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (23, 'key_path', 'wechat', 'API证书key（退款用）', '', 'string', '/home/wwwroot/drink.weivee.com/addons/unidrink/cert/apiclient_key.pem', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (24, 'cache_expire', 'basic', '配置缓存多少秒', '', 'number', '30', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (25, 'lock', 'basic', '减库存锁模式', '', 'radio', 'optimistic', '{"pessimism":"悲观锁","optimistic":"乐观锁"}', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (27, 'avatar', 'basic', '默认头像', '', 'image', 'http://cdn.shop.weivee.com/shop/20200408/6162b21922f336ae9b320bc06582ab7f.png', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (28, 'take-out', 'basic', '是否支持外卖', '', 'switch', '1', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (29, 'workspace_refresh', 'basic', '刷新工作台时间/秒', '', 'number', '3', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (30, 'order_number', 'basic', '取餐号初始值', '', 'number', '1000', '', '', '');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES (31, 'concurrent',	'basic', '工作台前几单表示制作中', '产品制作并发工作量', 'string', '5','','','');
INSERT INTO __PREFIX__unidrink_config (id, name, `group`, title, tip, type, value, content, rule, extend) VALUES
(32, 'takein', 'subscribe_msg', '堂食下单模板id', '模板标题：点餐成功通知；类目：餐厅排队', 'string', 'bzHpVRJV4ovQ0TH_29UwF3L7A5kaJiY2ob6cir9wUds', '', '', ''),
(33, 'takein_data', 'subscribe_msg', '堂食下单数据格式', '', 'array', '{\"取餐号码\":\"character_string3\",\"点餐时间\":\"time4\",\"订单状态\":\"phrase5\",\"取餐时间\":\"date8\",\"门店名称\":\"thing6\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', ''),
(34, 'takeout', 'subscribe_msg', '外卖下单模板id', '模板标题：外卖下单通知；类目：菜谱', 'string', 'dhFMAVspGcxvkwxgNTW6eOPRbYm1PsFBIZl7FNf-skg', '', '', ''),
(35, 'takeout_data', 'subscribe_msg', '外卖下单数据格式', '', 'array', '{\"订单号\":\"character_string1\",\"联系人姓名\":\"name2\",\"联系人手机号\":\"phone_number3\",\"时间\":\"date5\",\"地址\":\"thing6\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', ''),
(36, 'takein_made', 'subscribe_msg', '堂食取餐模板id', '模板标题：取餐提醒；类目：点评与推荐', 'string', '4DcZRZXCv7CilntJzulPawpoaIHMi-IwdJyqR4JWx70', '', '', ''),
(37, 'takein_made_data', 'subscribe_msg', '堂食取餐数据格式', '', 'array', '{\"取餐码\":\"character_string3\",\"温馨提示\":\"thing1\",\"下单时间\":\"time8\",\"取餐门店\":\"thing9\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', ''),
(38, 'takeout_made', 'subscribe_msg', '外卖配送模板id', '模板标题：配送通知；类目：点评与推荐', 'string', 'ltOmYnQ14OYzmjej2_ZEO6cDMzmDd-Z0BY5ADldtcfw', '', '', ''),
(39, 'takeout_made_data', 'subscribe_msg', '外卖配送数据格式', '', 'array', '{\"订单编号\":\"character_string1\",\"下单时间\":\"time8\",\"配送时间\":\"date2\",\"门店名称\":\"thing7\",\"温馨提示\":\"thing3\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', '');

--广告默认值--
INSERT INTO __PREFIX__unidrink_ads (id, image, switch, weigh, createtime, updatetime, shop_id) VALUES (5, 'https://static.zidaoai.com/activity/share/201906/18/1560838673_5d088211297c9.jpg', 1, 5, 1599480888, 1599482176, '0');

--我的服务--
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (1, '积分签到', 'https://cdn.shop.weivee.com/shop/20200603/f8f2b47150e726f1c2d51e6175bf43ff.png', 'pages', '', 0, '', '/pages/components/pages/integrals/integrals', 1, 1, 1591190560, 1594456666, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (2, 'uniShop商城', 'https://cdn.shop.weivee.com/shop/20200603/a423112a03c1cfb7e1c7ef254891e5b8.png', 'miniprogram', '', 0, 'wx73b3aa7f870c7d5c', '', 3, 1, 1591190663, 1591195509, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (3, '联系客服', 'https://cdn.shop.weivee.com/shop/20200603/851631ec932a899d198b45bed1afe1e1.png', 'pages', '', 0, '', '/pages/components/pages/contact/contact', 4, 1, 1591190832, 1591195498, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (4, '我的订单', 'https://cdn.shop.weivee.com/shop/20200603/51260e0bb8bb8afdcc2768ec25e043c1.png', 'pages', '', 0, '', '/pages/components/pages/orders/orders', 5, 1, 1591190907, 1591195493, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (5, '我的资料', 'https://cdn.shop.weivee.com/shop/20200603/2266f77a2cee99602f8f409c2a0df38a.png', 'pages', '', 0, '', '/pages/components/pages/mine/userinfo', 6, 1, 1591190951, 1591195480, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (6, '收货地址', 'https://cdn.shop.weivee.com/shop/20200603/7947fd52c7ded1f7cb415c83be949dc8.png', 'pages', '', 0, '', '/pages/components/pages/address/address', 7, 1, 1591192986, 1591193046, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (7, '更多服务', 'https://cdn.shop.weivee.com/shop/20200603/f9cc3793b44c454cc7aee9977169d412.png', 'menu', '', 0, '', '', 8, 1, 1591194797, 1591195429, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (15, '帮助中心', '', 'content', '<p>123123</p>', 7, '', '', 15, 1, 1591198804, 1591284484, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (17, '关于uniDrink', '', 'content', '', 7, '', '', 17, 1, 1591280327, 1591284003, null);
INSERT INTO __PREFIX__unidrink_service (id, name, image, type, content, pid, app_id, pages, weigh, status, createtime, updatetime, deletetime) VALUES (18, '退出登录', '', 'pages', '', 7, '', '/pages/components/pages/login/logout', 18, 1, 1597544959, 1597545316, null);

--充值金额--
INSERT INTO __PREFIX__unidrink_recharge (id, name, sales, value, weigh, status, sell_price, createtime, updatetime, deletetime) VALUES (8, '1元', 0, 1.00, 8, 1, 0.01, 1598090816, 1599486416, null);
INSERT INTO __PREFIX__unidrink_recharge (id, name, sales, value, weigh, status, sell_price, createtime, updatetime, deletetime) VALUES (9, '20元', 0, 20.00, 9, 1, 18.80, 1598099632, 1599486405, null);
INSERT INTO __PREFIX__unidrink_recharge (id, name, sales, value, weigh, status, sell_price, createtime, updatetime, deletetime) VALUES (10, '10元', 0, 10.00, 10, 1, 9.00, 1599312851, 1599312851, null);

--门店信息--
INSERT INTO __PREFIX__unidrink_shop (id, name, mobile, image, images, address, address_map, starttime, endtime, lng, lat, province, city, area, distance, min_price, delivery_price, notice, status, createtime, updatetime, deletetime, admin_id) VALUES (6, '红山店', '020-3736665', 'https://cdn.shop.weivee.com/shop/20200818/bb3bbbf2a87c12f1ab3c80e3330f6cf0.png', 'http://pic.rmb.bdstatic.com/819a044daa66718c2c40a48c1ba971e6.jpeg,http://img001.hc360.cn/y5/M00/1B/45/wKhQUVYFE0uEZ7zVAAAAAMj3H1w418.jpg', '广东省深圳市龙华区红木街', '广东省深圳市龙华区红木街', 1599436860, 1599487260, '114.02573', '22.62233', 1964, 1988, 1998, 0, 0.00, 0.00, '123', 1, 1597759514, 1599486614, null, '1');
INSERT INTO __PREFIX__unidrink_shop (id, name, mobile, image, images, address, address_map, starttime, endtime, lng, lat, province, city, area, distance, min_price, delivery_price, notice, status, createtime, updatetime, deletetime, admin_id) VALUES (7, '蜃城酒肆', '13000000000', 'https://cdn.shop.weivee.com/shop/20200822/6a553e7c6ca53908cc6ba69ebe359cda.jpg', 'https://cdn.shop.weivee.com/shop/20200822/6a5b92456f159599da1d64715c70062e.jpg', '广东省深圳市福田区深南大道', '广东省深圳市福田区深南大道', 1598742000, 1598802900, '114.06105', '22.54164', 1964, 1988, 1990, 5, 10.00, 5.00, '', 1, 1598054382, 1598769349, null, '1,2');


--分类信息--
INSERT INTO __PREFIX__unidrink_category (id, pid, type, name, nickname, flag, image, keywords, description, diyname, createtime, updatetime, weigh, status, shop_id) VALUES (15, 0, 'product', '白钻烧仙草', '', '', 'https://cdn.shop.weivee.com/shop/20200909/0bd394c79c9aff14285238d4738d3ead.jpeg', '招牌奶茶', '', '', 1599578427, 1599645254, 15, 'normal', '0');
INSERT INTO __PREFIX__unidrink_category (id, pid, type, name, nickname, flag, image, keywords, description, diyname, createtime, updatetime, weigh, status, shop_id) VALUES (18, 0, 'product', '招牌奶茶', '', '', '', '招牌奶茶', '', '', 1599645817, 1599645817, 18, 'normal', '0');
INSERT INTO __PREFIX__unidrink_category (id, pid, type, name, nickname, flag, image, keywords, description, diyname, createtime, updatetime, weigh, status, shop_id) VALUES (19, 0, 'product', '芒芒系列', '', '', '', '忙忙系列', '', '', 1599646297, 1599646836, 19, 'normal', '0');
INSERT INTO __PREFIX__unidrink_category (id, pid, type, name, nickname, flag, image, keywords, description, diyname, createtime, updatetime, weigh, status, shop_id) VALUES (20, 0, 'product', '应季果茶', '', '', '', '应季果茶', '', '', 1599646320, 1599646320, 20, 'normal', '0');
INSERT INTO __PREFIX__unidrink_category (id, pid, type, name, nickname, flag, image, keywords, description, diyname, createtime, updatetime, weigh, status, shop_id) VALUES (22, 0, 'product', '甜点', '', '', '', '', '', '', 1599653555, 1599653555, 22, 'normal', '0');

--商品信息--
INSERT INTO `__PREFIX__unidrink_product` (`id`, `category_id`, `title`, `image`, `images`, `desc`, `market_price`, `sales_price`, `sales`, `stock`, `look`, `use_spec`, `specList`, `specTableList`, `weigh`, `real_sales`, `real_look`, `switch`, `updatetime`, `createtime`, `deletetime`, `shop_id`, `condiment_id`, `no_buy_yet`) VALUES
(3, 19, '多肉芒芒甘露', 'https://cdn.shop.weivee.com/shop/20200909/4bc3ede5c7a6f250a290f583cdb186c2.jpg', 'https://cdn.shop.weivee.com/shop/20200909/4bc3ede5c7a6f250a290f583cdb186c2.jpg', '', '0.00', '20.00', 0, 0, 0, 1, '[{\"name\":\"常规\",\"child\":[\"约700毫升\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\"]},{\"name\":\"糖量\",\"child\":[\"正常\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"无糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"20\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"无糖\"]}]', 3, 0, 0, 1, 1599651101, 1599642223, NULL, '0', '0', 0),
(4, 19, '莓莓芒芒甘露', 'https://cdn.shop.weivee.com/shop/20200909/532bc838231f7e18f91b53c9d64470a8.jpeg', 'https://cdn.shop.weivee.com/shop/20200909/532bc838231f7e18f91b53c9d64470a8.jpeg', '', '0.00', '21.00', 0, 0, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\"]},{\"name\":\"糖量\",\"child\":[\"正常\",\"少糖\",\"半糖\",\"微糖\",\"多糖\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"0\",\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"多糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"21\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"多糖\"]}]', 4, 0, 0, 1, 1599650771, 1599649570, NULL, '0', '0', 0),
(5, 20, '桂香芭乐', 'https://cdn.shop.weivee.com/shop/20200909/3a4e980f0c275777438c3476b1ceccd5.jpg', 'https://cdn.shop.weivee.com/shop/20200909/3a4e980f0c275777438c3476b1ceccd5.jpg', '', '0.00', '16.00', 0, 0, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\",\"飞冰\"]},{\"name\":\"糖量\",\"child\":[\"正常\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"166\",\"stock\":110,\"value\":[\"约700毫升\",\"正常\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"正常\",\"无糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"少冰\",\"无糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"微冰\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"微冰\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"微冰\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"微冰\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"微冰\",\"无糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"飞冰\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"飞冰\",\"少糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"飞冰\",\"半糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"飞冰\",\"微糖\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":0,\"value\":[\"约700毫升\",\"飞冰\",\"无糖\"]}]', 5, 0, 0, 1, 1599651054, 1599651013, NULL, '0', '0', 0),
(6, 20, '香芋柠檬绿', 'https://cdn.shop.weivee.com/shop/20200909/94c86d932b7d2f7c0a0776d2e619a965.jpg', 'https://cdn.shop.weivee.com/shop/20200909/94c86d932b7d2f7c0a0776d2e619a965.jpg', '', '0.00', '15.00', 0, 0, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"150\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"15\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 6, 0, 0, 1, 1599651275, 1599651275, NULL, '0', '0', 0),
(7, 20, '3Q百香果', 'https://cdn.shop.weivee.com/shop/20200909/e02850e3c093820efc89fe22804699bd.jpg', 'https://cdn.shop.weivee.com/shop/20200909/e02850e3c093820efc89fe22804699bd.jpg', '', '0.00', '16.00', 0, 206, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"18\",\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"10\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"11\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"25\",\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"11\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"13\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"16\",\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"19\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"8\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"11\",\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"9\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"16\",\"stock\":\"19\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 7, 0, 0, 1, 1599660145, 1599651425, NULL, '0', '0', 0),
(8, 20, '百香果芒芒', 'https://cdn.shop.weivee.com/shop/20200909/5552caebe2aeb5a89e3a1390be088d41.jpg', 'https://cdn.shop.weivee.com/shop/20200909/5552caebe2aeb5a89e3a1390be088d41.jpg', '', '0.00', '18.00', 0, 0, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":0,\"sales_price\":\"18\",\"stock\":0,\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 8, 0, 0, 1, 1599651565, 1599651564, NULL, '0', '0', 0),
(9, 20, '满杯香橙', 'https://cdn.shop.weivee.com/shop/20200909/61115707899190d9443a8c9996549914.jpg', 'https://cdn.shop.weivee.com/shop/20200909/61115707899190d9443a8c9996549914.jpg', '', '20.00', '18.00', 300, 300, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"20\",\"sales_price\":\"18\",\"stock\":\"20\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 9, 0, 0, 1, 1601035796, 1599651621, NULL, '0', '0', 0),
(10, 20, '霸气橙子', 'https://cdn.shop.weivee.com/shop/20200909/f77e257fcfc8447827add4b37dac4f4b.jpg', 'https://cdn.shop.weivee.com/shop/20200909/f77e257fcfc8447827add4b37dac4f4b.jpg', '', '20.00', '17.00', 180, 180, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"12\",\"sales_price\":\"17\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 10, 0, 0, 1, 1601035757, 1599651688, NULL, '0', '0', 0),
(11, 20, '牛油果奶昔', 'https://cdn.shop.weivee.com/shop/20200909/6b61380f477d6f2ef86bafffe792da2c.jpg', 'https://cdn.shop.weivee.com/shop/20200909/6b61380f477d6f2ef86bafffe792da2c.jpg', '', '0.00', '21.00', 0, 47, 0, 0, NULL, NULL, 11, 0, 0, 1, 1601035737, 1599651752, NULL, '0', '0', 0),
(12, 20, '百香果益力多', 'https://cdn.shop.weivee.com/shop/20200909/e4e6c0da70384ba9bbf334bff2c4f729.jpg', 'https://cdn.shop.weivee.com/shop/20200909/e4e6c0da70384ba9bbf334bff2c4f729.jpg', '', '28.00', '15.00', 420, 420, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"全糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"少糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"半糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"微糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"无糖\",\"正常\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"28\",\"sales\":\"28\",\"sales_price\":\"15\",\"stock\":\"28\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\"]}]', 12, 0, 0, 1, 1601035728, 1599651830, NULL, '0', '0', 0),
(13, 18, '炭烧珍珠奶茶', 'https://cdn.shop.weivee.com/shop/20200909/c5f63c5ca5f7f21f6b240c1050ce686c.jpg', 'https://cdn.shop.weivee.com/shop/20200909/c5f63c5ca5f7f21f6b240c1050ce686c.jpg', '', '20.00', '13.00', 3990, 3990, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]},{\"name\":\"温度\",\"child\":[\"冷\",\"热\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"20\",\"sales\":\"133\",\"sales_price\":\"13\",\"stock\":\"133\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"热\"]}]', 13, 0, 0, 1, 1601035706, 1599652027, NULL, '0', '0', 0),
(14, 18, '蛋糕珍珠奶茶', 'https://cdn.shop.weivee.com/shop/20200909/2b49ad0e47456c3f1a92bf50f88b0141.jpg', 'https://cdn.shop.weivee.com/shop/20200909/2b49ad0e47456c3f1a92bf50f88b0141.jpg', '', '0.00', '17.00', 3000, 3000, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]},{\"name\":\"温度\",\"child\":[\"冷\",\"热\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"117\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":0,\"sales\":\"100\",\"sales_price\":\"17\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"热\"]}]', 14, 0, 0, 1, 1601035680, 1599652181, NULL, '0', '0', 0),
(15, 18, '白钻烧仙草', 'https://cdn.shop.weivee.com/shop/20200909/0bd394c79c9aff14285238d4738d3ead.jpg', 'https://cdn.shop.weivee.com/shop/20200909/0bd394c79c9aff14285238d4738d3ead.jpg', '', '15.00', '13.00', 4080, 4080, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]},{\"name\":\"温度\",\"child\":[\"冷\",\"热\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"15\",\"sales\":\"136\",\"sales_price\":\"13\",\"stock\":\"136\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"热\"]}]', 15, 0, 0, 1, 1601035430, 1599652235, NULL, '0', '0', 0),
(16, 18, '阿华田波波冰', 'https://cdn.shop.weivee.com/shop/20200909/deb7b648ed98f8cd401a29ee9ba42500.jpg', 'https://cdn.shop.weivee.com/shop/20200909/deb7b648ed98f8cd401a29ee9ba42500.jpg', '', '12.00', '8.00', 3000, 3000, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]},{\"name\":\"温度\",\"child\":[\"冷\",\"热\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"100\",\"sales_price\":\"8\",\"stock\":\"100\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"热\"]}]', 16, 0, 0, 1, 1601035285, 1599652328, NULL, '0', '0', 0),
(17, 18, '白钻奶绿', 'https://cdn.shop.weivee.com/shop/20200909/b71f98780f303d7f065b0288e68948a4.jpg', 'https://cdn.shop.weivee.com/shop/20200909/b71f98780f303d7f065b0288e68948a4.jpg', '', '12.00', '12.00', 360, 360, 0, 1, '[{\"name\":\"规格\",\"child\":[\"约700毫升\"]},{\"name\":\"甜度\",\"child\":[\"全糖\",\"少糖\",\"半糖\",\"微糖\",\"无糖\"]},{\"name\":\"冰量\",\"child\":[\"正常\",\"少冰\",\"微冰\"]},{\"name\":\"温度\",\"child\":[\"冷\",\"热\"]}]', '[{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"全糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"少糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"半糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"微糖\",\"微冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"正常\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"少冰\",\"热\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"冷\"]},{\"code\":0,\"image\":\"\",\"market_price\":\"12\",\"sales\":\"12\",\"sales_price\":\"12\",\"stock\":\"12\",\"value\":[\"约700毫升\",\"无糖\",\"微冰\",\"热\"]}]', 17, 0, 0, 1, 1601035254, 1599652360, NULL, '0', '0', 0),
(18, 22, '原味双皮奶', 'https://cdn.shop.weivee.com/shop/20200822/6a553e7c6ca53908cc6ba69ebe359cda.jpg', 'https://cdn.shop.weivee.com/shop/20200822/6a5b92456f159599da1d64715c70062e.jpg', '', '11.00', '11.00', 11, 3, 11, 0, NULL, NULL, 18, 8, 0, 0, 1599660100, 1599654873, NULL, '7', '0', 8);


--地区信息--

INSERT INTO `__PREFIX__unidrink_area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
-- 新增收入统计视图
--
CREATE VIEW `__PREFIX__unidrink_income` AS
SELECT o.createtime AS date_time, s.name AS shop_name, o.total_price AS order_amount, s.id as shop_id
FROM `__PREFIX__unidrink_order` AS o LEFT JOIN `__PREFIX__unidrink_shop` s ON o.shop_id = s.id
where o.status = 1 and o.have_paid != 0;

--
-- 1.1.0
-- 新增商品销量视图
--
CREATE VIEW `__PREFIX__unidrink_goods` AS SELECT o.shop_id,o.createtime AS date_time,op.order_id,op.product_id,op.number,p.title AS product_name
FROM `__PREFIX__unidrink_order` o
INNER JOIN `__PREFIX__unidrink_order_product` op ON o.id = op.order_id
LEFT JOIN `__PREFIX__unidrink_product` p ON op.product_id = p.id
where o.status = 1 and o.have_paid != 0;
...
-- 新增店铺绑定打印机字段
--
alter table `__PREFIX__unidrink_shop` add uniprint_id varchar(100) default '' null comment '打印机id';